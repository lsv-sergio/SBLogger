...
{
    public class ActivationProcedureDropParameter : BaseParameterBuilder<IServiceBrokerConfig>, IActivationProcedureDropParameter
    {
        public ActivationProcedureDropParameter()
        {
        }
