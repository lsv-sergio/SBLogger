...
{
    public class LogTableCreateDropParameter : BaseParameterBuilder<IServiceBrokerConfig>, ILogTableCreateDropParameter
    {
        public LogTableCreateDropParameter()
        {
        }
        ...
        {
            return !String.IsNullOrEmpty(configParameters.LogTableName);
        }
    }
}
